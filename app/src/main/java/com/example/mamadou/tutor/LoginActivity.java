...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailView = (AutoCompleteTextView) findViewById(R.id.studentUsername);
        populateAutoComplete();

        mPasswordView = (EditText) findViewById(R.id.studentPassword);
    ...
    private void attemptLogin() {
        ...
        if (userType == STUDENT) {
            ...
            storedPassword = dataBaseAdapter.getSinlgeEntryTableStudent(username);
        }
        else {
            // searching username from the database
            // fetch the Password form database for respective user name
    ...
    private boolean isEmailValid(String username) {
        ...
        username = "NOT EXIST";
        if(!storedPassword.equals(username)) {
            return true;
        }
        else {
            return false;
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                // go to the student Main page if userType == 1
                if (userType == STUDENT)  {
